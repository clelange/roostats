...
sed -i '.bak' 's/using namespace RooStats/import ROOT/g' ${FILE}
...
sed -i '.bak' "s/wks.import/getattr(wks, 'import')/g" ${FILE}
sed -i '.bak' "s/ws.import/getattr(ws, 'import')/g" ${FILE}
sed -i '.bak' "s/wspace.import/getattr(wspace, 'import')/g" ${FILE}
...
sed -i '.bak' 's/ROOT.RooAddPdf model(/model = ROOT.RooAddPdf(/g' ${FILE}
sed -i '.bak' 's/ ModelConfig/ ROOT.RooStats.ModelConfig(/g' ${FILE}
sed -i '.bak' 's/ FeldmanCousins/ ROOT.RooStats.FeldmanCousins(/g' ${FILE}
sed -i '.bak' 's/ ProfileLikelihoodCalculator/ ROOT.RooStats.ProfileLikelihoodCalculator(/g' ${FILE}
sed -i '.bak' 's/ LikelihoodIntervalPlot/ ROOT.RooStats.LikelihoodIntervalPlot(/g' ${FILE}
sed -i '.bak' 's/ ProposalHelper/ ROOT.RooStats.ProposalHelper(/g' ${FILE}
sed -i '.bak' 's/ MCMCCalculator/ ROOT.RooStats.MCMCCalculator(/g' ${FILE}
sed -i '.bak' 's/ MCMCIntervalPlot/ ROOT.RooStats.MCMCIntervalPlot(/g' ${FILE}
